...
## Changelog
```
- 3.4.2: Bump Dependency Requirements, re-compile, no changes.
- 3.4.1: migrate to DependencyUnityPlugins<T> to allow enable/disable the plugin without uninstalling it via chainloader
